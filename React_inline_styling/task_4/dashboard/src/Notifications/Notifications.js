...
// Fades the menu item from half to full opacity.
const opacityKeyframes = {
  '0%': { opacity: 0.5 },
  '100%': { opacity: 1 },
};

// Nudges the menu item up and then down again.
...
const styles = StyleSheet.create({
  ...
  // Applied once the panel is open, so the two never show at the same time.
  menuItemHidden: {
    display: 'none',
  },
});
